...
namespace PolarisStation {
    public class EcrenSolmazgul : BackendDeveloper {
        public string University => "Düzce University";
        public string Major => "Backend Software Development";
        public string[] FocusAreas => new[] { "Cybersecurity", "Game Development", "Banking Systems" };
    }
}
